...
| global | object | `{"pgdImageName":"postgresql-pgd:18.1-pgd620-expanded-ubi9","proxyImageName":"","repository":"docker.enterprisedb.com/k8s"}` | Global values |
...
| global.proxyImageName | string | `""` | Specifies the pgd-proxy image name to be used for the operator, the image will be downloaded from global repository |
