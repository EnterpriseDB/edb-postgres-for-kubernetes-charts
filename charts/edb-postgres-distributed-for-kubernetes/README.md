...
| global | object | `{"pgdImageName":"postgresql-pgd:17.6-pgd590-ubi9","proxyImageName":"edb-pgd-proxy:5.9.0-ubi9","repository":"docker.enterprisedb.com/k8s"}` | Global values |
