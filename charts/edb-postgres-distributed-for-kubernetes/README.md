...
| edb-postgres-for-kubernetes.image.imageCredentials | object | `{"create":true,"password":"","username":""}` | Additional Registries repository: docker.enterprisedb.com/k8s_standard_pgd/edb-postgres-for-kubernetes repository: docker.enterprisedb.com/k8s_community_pgd/edb-postgres-for-kubernetes |
| edb-postgres-for-kubernetes.image.repository | string | `"docker.enterprisedb.com/k8s_enterprise/edb-postgres-for-kubernetes"` |  |
